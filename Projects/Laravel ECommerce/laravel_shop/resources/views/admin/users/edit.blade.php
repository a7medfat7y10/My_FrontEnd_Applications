...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <img src="{{$photo ? $photo->name : 'https://placehold.it/400/400'}}" alt="" class="img-responsive img-rounded">
        </div>
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                {!! Form::select('is_approved', [1 => 'Approved', 0 => 'Not Approved'] , null, ['class'=>'form-control']) !!}
            </div>
            <div class="form-group">
