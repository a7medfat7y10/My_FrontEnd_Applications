...
<nav class="navbar navbar-expand-lg custom-nav">
    <div class="container-fluid">
        <a class="navbar-brand" href="index">
            <img src="<?php echo $img ?>EEGS.png" class="img-fluid" alt="Take the right track"/>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="has-sub dropdown">
                        <span class="submenu-button nav-link">
                            <i class="nav-icon icon-basic-anchor"></i>
                            Segments
                        </span>
                    <ul class="menu">
                        <li>
                                 <span>Technical</span>
                            <ul>
                                <li><a href="#popup1">Academy Committee</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <span>HR</span>
                            <ul>
                                <li><a href="#popup2">HR Committee</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <span>Treasure</span>
                            <ul>
                                <li><a href="#popup3">PR Committee</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                          <span>Operations</span>
                            <ul>
                                <li><a href="#popup4">Operations Committee</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <span>Marketing</span>
                            <ul>
                                 <li><a href="#popup5">Social Media Committee</a></li>
                                <li><a href="#popup6">Media Committee</a></li>
                                <li><a href="#popup7">IT Committee</a></li>
                            </ul>
                        </li>
...
<div id="popup2" class="overlay">
	<div class="popup">
		...
		<a class="close" href="#">&times;</a>
		<div class="content">
		 <p>" Nothing we do is more important than hiring and developing people. At the end of the day you bet on people, not on strategies"<br> This is what exactly How it's like to be an HR!<br> Being able to interview applicants in order to choose the best of the best who are capable of running our work with qualifications but also passion. Then the process of Evaluating and developing their skills and yours too as a future leader.It's one committee.. With tons of experiences to explore, a great place to discover and develop your abilities.. So don't hesitate and join us Now</p>
		</div>
	</div>
</div>
...
<div id="popup5" class="overlay">
	<div class="popup social">
		...
		<a class="close" href="#">&times;</a>
		<div class="content">
		 <p>Social media has become a major thing in our life. Its platforms and websites are used to promote a product or service. <br>Although the terms e-marketing and digital marketing are still dominant in academia, social media marketing is becoming more popular for practitioners and researchers. <br>The Social Media Committee is responsible for creating forums where members can permanently connect and interact on social networks. They regularly use social media to market events and membership. The Content of Social Media.. Social Media can reduce marketing costs significantly .It's a free way to distribute content to potential customers.. Facebook allowes businesses to creat pages and groups with no costs associated with them.Pizza Hut, Victoria Secret, iTunes and Starbucks are great examples of companies that have taten full advantage of Facebook pages as free advertising tool. <br>With this committee you also can learn how to express yourself..by writing articles in lots of fields technical or nontechnical</p>
		</div>
	</div>
</div>
...
<div id="popup8" class="overlay">
	<div class="popup">
		...
		<a class="close" href="#">&times;</a>
		<div class="content">
		 <p>Magazine Committee is responsible for launching our official magazine showing our professionalism keeping EEGS Suez in direct contact with the industry leaders and innovative engineers.
                        <br>
                        <br>
