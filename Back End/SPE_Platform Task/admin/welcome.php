      ...
      if (isset($_SESSION['user'])) { 
				...
				if ($do == "manage" ) { ?>
					...
					<div class="row">
					    <div class="col-12">
							...
							<h3 class="text-center">Welcome HR Manager: Mr Youssef</h3><br>
							<div class="row">
								<div class="col-md-3">
									...
									<form>
										<div class="row">
											...
											<div class="col-5">
												...
												<a class="btn btn-outline-secondary"  href="apps.json" download>Sheet</a>
											</div>
										</div>
									</form>
								</div>
					...
					$stmt = $con->prepare('SELECT * FROM applicants WHERE id = ? LIMIT 1');
					...
					<form  action="" method="POST">
						...
						<textarea class="form-control" type="text" name="q4" value="" placeholder="What skills do you have ?"><?php echo $applicant['q4']; ?></textarea>
					...
					<form id='addform' action="" method="POST">
						...
						<textarea class="form-control"   type="text"    name="q4"				 placeholder="What skills do you have ?"></textarea>
		...
		<script>
			function server(req, id , select) {
				...
				var custom_massage = "Dear Applicant, We hope you are doing well. Congratulations, you have passed the first step of the recruitment process. The next step is the interview, you will be informed by the date of the interview very soon. Take into account to prepare well for the interview. This video may help you to know how to pass the interview successfully: https://youtu.be/YwWMhi9uPu0 You also can find out more information about SPE SU SC, our products and achievements by visiting our website: https://www.spesusc.com/ Thanks in advance and Good Luck! Kind Regards, SPE SU SC'21 HRM";
					...
					if ($('select[name=typemassage]').val() == 'normal') {
						...
						$('textarea[name=mailcontent]').slideDown().html(custom_massage);
						$('p#massage').slideUp();
					}else{
