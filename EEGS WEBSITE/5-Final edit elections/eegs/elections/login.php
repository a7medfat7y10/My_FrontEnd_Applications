...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['login'])) {
        ...
        $stmt = $con->prepare("SELECT  id FROM poll_users WHERE id = ? "); //as i did in database 1 for admin 0 for user
...
<div class="container login-page">
    ...
    <form class="login" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
        <input class="form-control" type="text" name="id" autocomplete="off" placeholder="Enter your EEGS ID" required />
