...
<p style="text-align: center;"> <img src="<?php echo $img?>EEGS_Blue.png" style="position: relative;width:25px;height: 35px;margin-top: -65px;background-color: #ffffff;"></p>
    ...
    <br> <br>
    <!-- Start Oil Price -->
      <section class="oil_price">
         <div class="container">
            <div class="text-center mb-3">
                <h4 class="heading">Brent Oil Price</h4>
                   <hr style="max-width: 100px;border:solid 1.5px #226131;">
                    <p style="text-align: center;"> <img src="<?php echo $img?>EEGS_Blue.png" style="position: relative;width:25px;height: 35px;margin-top: -65px;background-color: #ffffff;"></p>
            </div>
          
          <div  style="text-align: center;">
             <script type="text/javascript" src="https://www.oilcrudeprice.com/oilwidget.php?l=en&m=000000&g=ffffff&c=2d6ab4&i=ffffff&l=2d6ab4&o=e6f2fa&u=brent"></script>
          </div>
    </div> 
    </section>
<!-- end Oil Price -->
